...
class CWSB_Seller_Vendor_Queries
{
    ...
    public static function get_active_dashboard_seller_rows($page, $per_page)
    {
        ...
        $rows = $wpdb->get_results(
            $wpdb->prepare($sql, $cap_key, self::vendor_capability_like(), $now_ms, $per_page, $offset),
            ARRAY_A
        );
    ...
    public static function count_active_sellers()
    {
        ...
        return (int) $wpdb->get_var($wpdb->prepare($sql, $cap_key, self::vendor_capability_like(), $now_ms));
    }
